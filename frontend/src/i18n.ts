...
const messages: Record<SupportedLocale, TranslationTree> = {
    'zh-CN': {
        ...
        app: {
            ...
            startupLoading: '正在加载本地持仓数据…',
            startupLoadFailed: '启动数据同步失败',
            retryStartupLoad: '重新同步',
    ...
    'en-US': {
        ...
        app: {
            ...
            startupLoading: 'Loading saved portfolio data…',
            startupLoadFailed: 'Initial data sync failed',
            retryStartupLoad: 'Retry sync',
            ...
            marketDataRetry: 'Quote or FX sync failed. Please retry.',
