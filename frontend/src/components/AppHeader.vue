<script setup lang="ts">
    ...
    function isInteractiveTarget(target: EventTarget | null): boolean {
        ...
        return Boolean(
            target.closest("button, a, input, textarea, select, [role='button'], [data-window-dblclick-ignore='true']"),
        );
    }
        ...
        <div class="window-tools">
            ...
            <div v-if="showWindowControls" class="window-controls">
                ...
                <button
                    ...
                    class="window-control-button"
                    data-window-dblclick-ignore="true"
                    :aria-label="maximised ? t('windowControls.restore') : t('windowControls.maximise')"
                    @click="handleToggleMaximise"
                >
                    <i
                        class="pi"
                        :class="maximised ? 'pi-window-minimize' : 'pi-window-maximize'"
                        aria-hidden="true"
                    ></i>
                </button>
                <button
